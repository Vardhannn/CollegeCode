...
totalprocess = int(input("Enter number of process : "))
proc = []
for i in range(5):
    l = []
    for j in range(4):
...
if __name__ =="__main__":
    arrivaltime = list(map(int,input("enter the arrival time : ").split()))
    bursttime = list(map(int,input("enter the burst time : ").split()))
